...
### Notes
1. A pointed out in Hernán _et al_. (2011), a problem in Simpson's original paper is that his example was not entirely convincing: the particular measure of association that he used, _the odds ratio_, has certain mathematical properties that weakened his argument. This has led to a very different interpretation of the Simpson's Paradox. I have ignored this issue completely in this post.
